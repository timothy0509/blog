  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        transition={{ duration: 0.15, ease: [0.4, 0, 0.2, 1] }}
        className="border-[6px] border-black bg-white shadow-[8px_8px_0_0_#000]"
      >
        {/* Header with Toggle Button */}
        <button
          onClick={() => setIsExpanded(!isExpanded)}
          className="w-full px-4 py-3 flex items-center justify-between font-display uppercase text-lg font-bold border-b-4 border-black bg-[#DFE104] hover:bg-black hover:text-white transition-all duration-150 focus:outline-none focus-visible:ring-4 focus-visible:ring-[#DFE104] focus-visible:ring-offset-0 active:translate-x-[2px] active:translate-y-[2px]"
          aria-expanded={isExpanded}
          aria-controls="toc-content"
        >
          <span className="tracking-tight">Contents</span>
          <motion.span
        ...
        <AnimatePresence initial={false}>
          {isExpanded && (
            <motion.div
              ...
              className="p-4 lg:max-h-[calc(100vh-12rem)] lg:overflow-y-auto"
            >
