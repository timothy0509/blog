    ...
    <div className="min-h-screen bg-[#fafafa] text-zinc-900 font-[family-name:var(--font-inter)] selection:bg-zinc-900 selection:text-white">
      <div className="max-w-3xl mx-auto px-6 py-24">
        ...
        <main className="prose prose-zinc max-w-none prose-lg
          ...
          prose-code:bg-zinc-100 prose-code:px-1.5 prose-code:py-0.5 prose-code:rounded-md prose-code:text-sm prose-code:font-medium prose-code:before:content-none prose-code:after:content-none
