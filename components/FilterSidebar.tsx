...
/** Desktop sticky filter rail — not used on mobile. */
export default function FilterSidebar({
  ...
  return (
    <aside
      id="filter-sidebar"
      className="hidden lg:block lg:col-span-3 sticky top-28 self-start w-full max-h-[calc(100vh-8rem)]"
    >
      <div
        ref={scrollRef}
          ...
          {moreOpen && (
            <div className="p-6 flex flex-col gap-6">
              ...
              <div>
                ...
                <div className="flex flex-col gap-2 max-h-48 overflow-y-auto scrollbar-hidden">
                  {events.map((event) => (
                    <button
                      key={event}
                      type="button"
